          ...
          {page==="products" && (
            <div className="page-content">
              <div className="page-toolbar">
                ...
                <input className="m3-text-field" placeholder="🔍 Cari..." value={prodSearch} onChange={e=>setProdSearch(e.target.value)} style={{maxWidth:180}} />
                <button className="btn btn-filled" style={{whiteSpace:"nowrap"}} onClick={()=>setShowProductForm({id:null,name:"",price:"",category:"Makanan",stock:"",sku:"",barcode:""})}>+ Tambah</button>
              </div>
          ...
          {page==="transactions" && (
            <div className="page-content">
              <div className="page-toolbar">
                ...
                <input className="m3-text-field" placeholder="🔍 Cari..." value={trxSearch} onChange={e=>setTrxSearch(e.target.value)} style={{maxWidth:180}} />
              </div>
              <div className="table-wrap">
                <table className="m3-table">
